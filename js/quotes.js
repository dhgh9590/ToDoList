...
function random(){
    const quotes = [
        ...
        {   
            quote: "Seize the moment of excited curiosity on any subject to solve your doubts; for if you let it pass, the desire may never return.",
            author: "William Wirt",
        },
        {   
    ...
    const quote = document.querySelector(".todo_title_cont p:first-child");
    const author = document.querySelector(".todo_title_cont p:last-child");
